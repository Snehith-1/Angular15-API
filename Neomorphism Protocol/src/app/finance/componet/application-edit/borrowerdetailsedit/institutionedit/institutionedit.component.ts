...
export class InstitutioneditComponent extends EventEmitter implements OnInit {
...
newGstDetails(){
  ...
  addGST(){
    debugger
  //  if(this.headoffice_status=="Yes")
  //  {
  //  this.headoffice_status= "Yes";
  //  }
  //  else if (this.headoffice_status==undefined)
  //  {
   ...
   console.log(this.headoffice_status)
    ...
    this.socketService.post(urlinstitutionadd,params).subscribe((responseurlinstitutionadd:any)=>{
      if (responseurlinstitutionadd.status == true) {
        ...
        //   var params2 = {
        //     institution_gid: 'APIN202306213459',
        // }
  ...
  //   this.GSTdata[this.GSTdata.length-1].gstHeadOffice = false;
  // }
        ...
        this.institutionlist();
        // this.gstObj ={
        //   gstsource:'Manually added',   
        //   gst_no:'',
        //   headoffice_status:'No',
        //   gst_state:''
        // };
        // this.GSTdata.push(this.gstObj);
        // this.GSTdata[this.GSTdata.length-1].gstHeadOffice = false;
  ...
  headstatusaction(institution2branch_gid:any){
    ...
    switch (this.addressDetailsFormGroup.invalid) {
      ...
      this.socketService.getparams(geocodeurl,addressparams).subscribe((responsegeocode: any) => {
        ...
        this.socketService.post(urladdressadd, this.params).subscribe((responseaddressAdd: any) => {
         ...
         alert(responseaddressAdd.message);
        }
    });
  }
    ...
    this.socketService.getparams(urldeleteaddress, this.params).subscribe((responsedeleteaddress:any) => {
      //this.ngOnInit();
        ...
        if (responsedeleteaddress.status == true) {
          this.addresslist();
          alert(responsedeleteaddress.message);
        }
        else {
          alert(responsedeleteaddress.message);
        }
  ...
  addresslist(){
    var urlAddressaddedlist = "MstApplicationAdd/GetInstitutionAddressList";  
 ...
 console.log(this.contact)
  ...
  nextButton(){
    ...
    if(this.subMenuTitle == 'Institution'){
      switch (this.institutionFormGroup.invalid) {
        ...
        var institutionsubmiturl = 'MstNgApplicationEdit/UpdateInstitutionDtl';
  ...
  onchangebusinessstartdate(){
    ...
    this.socketService.getparams(urlgetbuisnessvintage, this.params).subscribe((responsebuisnessvintage: any) => {
      this.businessVintage.setValue(responsebuisnessvintage.year_business);
    });
...
var urlInstitutionGSTList="MstApplicationEdit/InstitutionGSTList";
debugger
 //this.institution_gid ='ITGSA202206040085';
this.params=
{
  institution_gid:this.institution_gid,
}
this.socketService.getparams(urlInstitutionGSTList,this.params).subscribe((responseInstitutionGSTList: any) => {
 debugger
...
var urlInstitutionGSTList = 'MstApplicationEdit/InstitutionDetailsEdit';
this.socketService.getparams(urlInstitutionGSTList,this.params).subscribe((responseInstitutionGSTList: any) => {
  debugger
  this.response=responseInstitutionGSTList; 
  console.log(this.response);
  this.institutionFormGroup.get("panValue")?.setValue(this.response.companypan_no);
  this.institutionFormGroup.get("legalTradeName")?.setValue(this.response.company_name);
  this.institutionFormGroup.get("lei")?.setValue(this.response.lei_no);
  this.institutionFormGroup.get("leirenewaldate")?.setValue(this.response.renewaldue_date);
  this.institutionFormGroup.get("cin")?.setValue(this.response.cin_no);
  this.institutionFormGroup.get("cinDate")?.setValue(this.response.cin_date);
  this.institutionFormGroup.get("businessStartDate")?.setValue(this.response.businessstartdate);
  this.institutionFormGroup.get("tan")?.setValue(this.response.tan_number);
  this.institutionFormGroup.get("tanstate_name")?.setValue(this.response.tanstate_name);
  this.institutionFormGroup.get("kin")?.setValue(this.response.kin_no);
  this.institutionFormGroup.get("udhayamRegistration")?.setValue(this.response.udhayam_registration);
  this.institutionFormGroup.get("categoryAml")?.setValue(this.response.amlcategory_name);
  this.institutionFormGroup.get("categoryBusiness")?.setValue(this.response.businesscategory_name);
  this.institutionFormGroup.get("nearestSamunnatiBranch")?.setValue(this.response.nearsamunnatiabranch_name);
  this.institutionFormGroup.get("lmsUrnStatus")?.setValue(this.response.urn_status);
  //this.institutionFormGroup.get("panValue")?.setValue(this.response.urn);
  ...
  ngOnInit(): void {
   ...
   this.route.queryParams.subscribe(params => {
     ...
     this.application_gid = params['lsapplication_gid'];
     this.institution_gid = params['lsinstitution_gid'];
    ...
    debugger
          ...
          if (hash) {
            ...
            this.subMenuTitle = searchObject.lspage;
