...
namespace ems.system.Controllers
{
    ...
    public class EntityController : ApiController
    {
        ...
        DaEntity objDaCustomer = new DaEntity();

        // Customer Add
        [ActionName("PostEntity")]
        [HttpPost]
        public HttpResponseMessage PostEntity(entity_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaCustomer.DaPostEntity(getsessionvalues.user_gid, values);
        ...
        public HttpResponseMessage GetModuleSummary()
        {
            ...
            objDaCustomer.DaGetEntitySummary(values);
        ...
        {
            entity_list objresult = new entity_list();
            objDaCustomer.DaGetdeleteentitydetails(entity_gid, objresult);
            return Request.CreateResponse(HttpStatusCode.OK, objresult);
        }
        [ActionName("Getupdateentitydetails")]
        [HttpPost]
        public HttpResponseMessage Getupdateentitydetails(entity_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaCustomer.DaGetupdateentitydetails(getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, true);
        }
