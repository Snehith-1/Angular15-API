...
namespace ems.crm.DataAccess
{
    ...
    public class DaMarketingCurrency
    {
        ...
        public void DaGetMarketingCurrencySummary(MdlMarketingCurrency values)
        {
        ...
        public void DaGetcountrydropdown(MdlMarketingCurrency values)
        {
        ...
        public void DaGetbreadcrumb(string user_gid, string module_gid, MdlMarketingCurrency values)
        {
