...
namespace ems.pmr.Controllers
{
    ...
    public class ProductController : ApiController
    {
        ...
        [HttpGet]
        public HttpResponseMessage deleteProductSummary(string product_gid)
        {
            product_list objresult = new product_list();
            objDaPurchase.DadeleteProductSummary(product_gid, objresult);
            return Request.CreateResponse(HttpStatusCode.OK, objresult);
        }

        [ActionName("editProductSummary")]
        [HttpGet]
        public HttpResponseMessage editProductSummary(string user_gid, string product_gid)
        {
            MdlProduct objresult = new MdlProduct();
            objDaPurchase.DaeditProductSummary(user_gid, product_gid, objresult);
            return Request.CreateResponse(HttpStatusCode.OK, objresult);
        }
