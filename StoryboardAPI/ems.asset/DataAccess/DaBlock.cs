...
namespace ems.asset.DataAccess
{
    public class DaBlock
    {
        ...
        public void DaGetunitdropdown(MdlBlock values)
        {
        ...
        public void DaPostBlock(string user_gid, block_list values)
        {
            ...
            msSQL = " Select locationunit_name from adm_mst_tcountry where locationunit_gid = '" + values.locationunit_name + "'";
            string lsunit_name = objdbconn.GetExecuteScalar(msSQL);
